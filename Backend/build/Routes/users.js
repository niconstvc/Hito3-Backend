    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          console.error('Error al obtener los usuarios:', _context.t0.message);
          res.status(500).json({
            success: false,
...
router.post('/', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, name, email, _yield$db$query2, rows;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 11:
          ...
          console.error('Error al agregar el usuario:', _context2.t0.message);
          res.status(500).json({
            success: false,
...
router.put('/:id', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var id, _req$body2, name, email, _yield$db$query3, rows;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          _context3.prev = 4;
          _context3.next = 7;
          return db.query('UPDATE users SET name = $1, email = $2 WHERE id = $3 RETURNING *', [name, email, id]);
        case 7:
        ...
        case 14:
          ...
          console.error('Error al actualizar el usuario:', _context3.t0.message);
          res.status(500).json({
            success: false,
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 11:
          ...
          console.error('Error al eliminar el usuario:', _context4.t0.message);
          res.status(500).json({
            success: false,
