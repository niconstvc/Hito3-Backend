    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          console.error('Error al obtener los proyectos:', _context.t0.message);
          res.status(500).json({
            success: false,
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          _context2.prev = 3;
          _context2.next = 6;
          return db.query('INSERT INTO projects (title, description) VALUES ($1, $2) RETURNING *', [title, description]);
        case 6:
        ...
        case 11:
          ...
          console.error('Error al agregar el proyecto:', _context2.t0.message);
          res.status(500).json({
            success: false,
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          _context3.prev = 4;
          _context3.next = 7;
          return db.query('UPDATE projects SET title = $1, description = $2 WHERE id = $3 RETURNING *', [title, description, id]);
        case 7:
        ...
        case 14:
          ...
          console.error('Error al actualizar el proyecto:', _context3.t0.message);
          res.status(500).json({
            success: false,
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.prev = 1;
          _context4.next = 4;
          return db.query('DELETE FROM projects WHERE id = $1 RETURNING *', [id]);
        case 4:
        ...
        case 11:
          ...
          console.error('Error al eliminar el proyecto:', _context4.t0.message);
          res.status(500).json({
            success: false,
