...
function _getUserById() {
  _getUserById = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
...
function _createUser() {
  _createUser = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body, username, password, email, hashedPassword, query, _yield$db$query3, rows;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          ...
          _context3.next = 8;
          return db.query(query, [username, hashedPassword, email]);
        case 8:
...
function _updateUser() {
  _updateUser = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var id, _req$body2, username, password, email, hashedPassword, query, _yield$db$query4, rows;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 10:
          hashedPassword = _context4.t0;
          query = "\n      UPDATE users \n      SET username = COALESCE($1, username), \n          password = COALESCE($2, password), \n          email = COALESCE($3, email) \n      WHERE id = $4 \n      RETURNING *";
          _context4.next = 14;
          return db.query(query, [username, hashedPassword, email, id]);
        case 14:
        ...
        case 21:
          ...
          console.error('Error al actualizar usuario:', _context4.t1);
          res.status(500).json({
...
function _deleteUser() {
  _deleteUser = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
